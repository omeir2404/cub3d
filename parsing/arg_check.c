...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/05/07 15:52:09 by oharoon           #+#    #+#             */
/*   Updated: 2024/05/07 15:52:09 by oharoon          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief checks if the file exists and given has
 * the correct permissions to be readable
 * @return 0 if correct, -1 if not correct
*/
